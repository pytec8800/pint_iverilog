...
typedef struct ivl_task_stack_info_s    *ivl_task_stack_info_t;
...
extern int ivl_design_scope(ivl_design_t des, ivl_scope_f func, void *cd);
...
extern ivl_expr_t ivl_new_expr(ivl_expr_type_t type, ivl_variable_type_t value, unsigned width, unsigned issigned, unsigned sized);
extern void ivl_set_expr_signal(ivl_expr_t expr, ivl_signal_t sig_ , ivl_expr_t word_);
extern void ivl_set_expr_binary(ivl_expr_t expr, char op, ivl_expr_t left, ivl_expr_t right);
...
extern unsigned pint_lpm_size(ivl_lpm_t net);
  /* IVL_LPM_SFUNC */
...
extern const char*  ivl_scope_name_c(ivl_scope_t net);
extern int ivl_task_need_pc(ivl_scope_t net);
extern int ivl_task_cur_stack_size(ivl_scope_t net);
extern int ivl_task_max_stack_size(ivl_scope_t net);
extern const void* ivl_task_wait_events(ivl_scope_t net);
...
extern unsigned ivl_scope_func_para_width(ivl_scope_t net, int para_idx);
...
extern const char* ivl_signal_name_c(ivl_signal_t net);
